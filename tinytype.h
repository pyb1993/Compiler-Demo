...
/* book-keeping tokens */
{
	...
	RSQUARE, CHARACTER, STRING, STRUCT,CONST,SWITCH,CASE,DEFAULT,CONVERSION,SIZEOF,TYPEDEF,
	/*variable type*/
...
typedef enum { IfK, RepeatK, ReadK, WriteK, DeclareK, BlockK, SwitchK,CaseK,DefaultK, DefineK, StructDefineK, ParamK, BreakK, ContinueK, ReturnK, AsmK, ImportK } StmtKind;
...
bool isStructFunction(const char *);
